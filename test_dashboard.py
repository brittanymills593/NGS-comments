...
def run_test_dashboard():
    ...
    if selected_disease != st.session_state.previous_disease:
        ...
        # Reset CLL selections when changing disease
        st.session_state.cll_infiltration = None
        st.session_state.cll_cnv = None
    ...
    # ---------------------------------------
    # Clear confidence gene inputs when
    # disease or genes change
    # ---------------------------------------
    ...
    # ---------------------------------------
    # Medium and Low confidence boxes
    # ---------------------------------------
    ...
    if selected_disease == "CLL":
        ...
        try:
            ...
            # Available infiltration options from column A
            ...
            # ---------------------------------------
            # CNV options based on infiltration
            # ---------------------------------------
            ...
            with col2:
                ...
                if infiltration:
                    ...
                    matching_cnv_df = cll_cnv_df[
                        cll_cnv_df["Infiltration"] == infiltration
                    ]
    ...
    if selected_disease and input_genes:
        ...
        try:
            ...
            # Display genes with no comments
            ...
            if auto_panel:
                ...
                if not result.empty:
                    ...
                    if marker in panel_text:
                        ...
                        intro, remainder = panel_text.split(
                            marker,
                            1
                        )
                        ...
                        if " genes." in remainder:
                            ...
                            gene_string, ending = remainder.split(
                                " genes.",
                                1
                            )
                ...
                if selected_disease == "CLL" and cll_comment:
