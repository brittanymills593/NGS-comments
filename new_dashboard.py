        ...
        try:
            ...
            if auto_panel:
                ...
                if not result.empty:
                    ...
                    # Split into:
                    # 1. Text before the gene list
                    # 2. Gene list
                    # 3. Everything after " genes."
                    if marker in panel_text:
                    
                        intro, remainder = panel_text.split(marker, 1)
                    
                        if " genes." in remainder:
                    
                            gene_string, ending = remainder.split(" genes.", 1)
                            ...
                            # Fallback if " genes." isn't present
                            rebuilt_text = panel_text
                    
                    else:
                        # Fallback if the standard wording isn't present
                        rebuilt_text = panel_text
                    
                    output_text.append(rebuilt_text)
